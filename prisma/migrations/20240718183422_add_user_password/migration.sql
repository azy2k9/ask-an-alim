...
-- CreateEnum
CREATE TYPE "AnswerStatus" AS ENUM ('ANSWERED', 'NOT_ANSWERED');
...
-- AddForeignKey
ALTER TABLE "Question" ADD CONSTRAINT "Question_answeredUserId_fkey" FOREIGN KEY ("answeredUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
